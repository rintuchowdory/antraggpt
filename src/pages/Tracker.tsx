  ...
  return (
    <div className="page-content">
      <div className="page-header"><div>
        ...
        <p className="page-subtitle">{lang==='de'?'Status und Export':'Track and export'}</p>
      </div></div>
      {applications.length===0 ? (
        <div className="empty-state"><FileText size={48}/><h3>{lang==='de'?'Noch keine Anträge':'No applications yet'}</h3></div>
      ) : (
            ...
            return (
              <div key={app.id} className="tracker-card">
                <div className="tracker-top">
                  ...
                  <button className="pdf-btn" onClick={()=>exportToPDF(app.formTitle,app.data,lang)}>
